...
class Settings(BaseSettings):
    ...
    VANNA_MODEL: str = "openai/gpt-4.1-mini"     # OpenAI model for SQL generation
    ...
    STORAGE_BACKEND: Literal["s3", "local"] = "local"         # Options: "local", "s3"
    ...
    S3_CACHE_BUCKET: str = "rag-proj2-cache-bucket"
