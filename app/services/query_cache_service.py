...
class QueryCacheService:
    ...
    def __init__(self, redis_url: Optional[str] = None, redis_token: Optional[str] = None):
        ...
        if redis_url and redis_token:
            try:
                ...
                logger.warning("⚠️  upstash-redis package not installed. Cache disabled. "
                    "Install with: pip install upstash-redis>=0.15.0")
                
            except Exception as e:
                logger.warning(f"⚠️ Failed to coonect to Upstash redis: {e}"
                               f"Cache Disabled. App will continue without cache")
    ...
    def get(self, key: str, cache_type: str = "rag") -> Optional[Any]:
        """
    ...
    def set(self, key: str, ttl: int, value: Any, cache_type: str = "rag") -> bool:
        """
    ...
    def delete(self, pattern: str) -> int:
        ...
        try:
            ...
            logger.info(f"Cache ivalidation, deleted {deleted} keys matching '{pattern}'")
            return deleted
